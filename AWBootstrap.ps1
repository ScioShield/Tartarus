...
# Unpack the archive
Expand-Archive C:\vagrant\apps\elastic-agent-8.7.0-windows-x86_64.zip -DestinationPath 'C:\Program Files\'
...
& 'C:\Program Files\elastic-agent-8.7.0-windows-x86_64\elastic-agent.exe' install -f --url=https://atomicfirefly-elastic:8220 --certificate-authorities='C:\vagrant\certs\ca.crt' --enrollment-token=$(Get-Content C:\vagrant\tokens\WAEtoken.txt)
